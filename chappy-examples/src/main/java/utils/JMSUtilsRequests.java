...
import static utils.ValidationUtils.assertNull;
import static utils.ValidationUtils.assertFalse;
...
public final class JMSUtilsRequests {
	 ...
	 * @throws Exception
	 */
	public static ChappyClientTransactionHolder chappyLogin(final String host, final int serverPort) throws Exception {
		ChappyJMSLogin login = new ChappyJMSLogin("system", "system", true);
		login.createConnectionToServer(host, serverPort);
		login.send();
