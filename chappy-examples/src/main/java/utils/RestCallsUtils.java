...
public final class RestCallsUtils {
	...
	static final public String CUSTOM_TRANSFORMERS_DUMMY = "transformers.dummy";
	...
	public static Response addPrePostProcessingSteps(WebTarget target, NewCookie cookie) throws Exception {
		Response response;
