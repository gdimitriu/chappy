...
public interface IRestResourcesConstants {
	...
	public static final String REST_TRANSFORMER = "transformer";

	public static final String REST_TRANSFORMER_BY_USER = "transformerByUser";
}
